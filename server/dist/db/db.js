...
const dbFilePath = path_1.default.resolve(__dirname, '../../../plant_data.db');
/**
    ...
    return new Promise((resolve, reject) => {
        try {
            ...
            try {
                ...
                const alertsColumns = db.pragma('table_info(alerts)');
                ...
                const sensorColumns = db.pragma('table_info(sensor_readings)');
            ...
            try {
                const existingStages = db.prepare('SELECT COUNT(*) as count FROM plant_stages').get();
